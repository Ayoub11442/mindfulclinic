    ...
    <nav className="bg-white shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:flex items-center">
            <Link
              to="/booking"
              className="bg-clinic-blue text-clinic-gray px-4 py-2 rounded-md text-sm font-medium hover:bg-clinic-gray hover:text-white transition-colors"
            >
              Book Appointment
            </Link>
          </div>
      ...
      <div className={`sm:hidden ${isMenuOpen ? 'block' : 'hidden'}`} id="mobile-menu">
        ...
        <div className="px-2 pb-3">
          <Link
            to="/booking"
            className="bg-clinic-blue text-clinic-gray block px-4 py-2 rounded-md text-base font-medium hover:bg-clinic-gray hover:text-white transition-colors"
            onClick={() => setIsMenuOpen(false)}
          >
            Book Appointment
          </Link>
